...
<body>
    ...
    <div class="container col-5" id="Schoolproject duurzaam huis">
        ...
        <img src="/portfolio/Data/images/schoolproject-duurzaamheid.png" style="float: right" height="200em">
    </div>
    <div class="container col-6" id="Een retro scifi auto">
        <img src="/portfolio/Data/images/car-1-blender.png" style="float: right" height="200em">
        ...
        <img src="/portfolio/Data/images/car-2-blender.png" style="float: left" height="200em">
    </div>
    <div class="container col-5" id="Minesweeper in JavaScript">
        ...
        <img src="/portfolio/Data/images/minesweeper.png" style="float: right" height="200em">
    </div>
    <div class="container col-6" id="Asteroids-online in JavaScript">
        <img src="/portfolio/Data/images/asteroids-online.png" style="float: left" height="200em">
        <p style="display:inline-block" class="col-6">
